...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/girlcoin-project/girlcoin>";
    const std::string URL_WEBSITE = "<https://girlcoin.org>";
