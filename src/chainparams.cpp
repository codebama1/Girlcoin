...
{
    const char* pszTimestamp = "BBC.com 27/May/2018 Tomorrow's cities: Google's Toronto city built from the internet up";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1527649400, 2087798831, 0x1e0ffff0, 1, 50 * COIN);
        ...
        vSeeds.emplace_back("seed-a.girlcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.girlcointools.com", true);
        vSeeds.emplace_back("dnsseed.girlcoinpool.org", true);
        ...
        chepointData = (CCheckpointData) {
            {
                {  0, uint256S("0x23ffe5ca665fcf4180b8ffe7a71c834a424807e433de98c4601fbfc6e6c9c6a4")}
            }
        };

        chainTxData = ChainTxData{
            // Data as of block 59c9b9d3fec105bdc716d84caa7579503d5b05b73618d0bf2d5fa639f780a011 (height 1353397).
            1527649400, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.girlcointools.com", true);
        vSeeds.emplace_back("seed-b.girlcoin.loshan.co.uk", true);
