...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s girlcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  girlcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded girlcoin transaction") + "\n" +
              "  girlcoin-tx [options] -create [commands]   " + _("Create hex-encoded girlcoin transaction") + "\n" +
              "\n";
