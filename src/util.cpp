...
const char * const BITCOIN_CONF_FILENAME = "girlcoin.conf";
const char * const BITCOIN_PID_FILENAME = "girlcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Girlcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Girlcoin";
#else
    // Unix
    return pathRet / ".girlcoin";
#endif
#endif
}
